...
namespace UnitySimpleLiquid
{
    ...
    public class LiquidContainer : MonoBehaviour
    {
        ...
        [SerializeField]
        private GameObject reactionEffect;
        private float preAmountPercent;
        ...
        private void Start()
        {
            ...
            preAmountPercent = fillAmountPercent;
        }
        ...
        //updarte surface pos of water in falsk
        ...
        //calculdate updated surface height
        ...
        //update wobble when flask waved
        ...
        private void FixedUpdate()
        {
            ...
            if(fillAmountPercent > preAmountPercent) 
            {
                reactionEffect.SetActive(true);
                effectTime = 0;
            }
            if(effectTime > 5 && reactionEffect.activeSelf) 
            {
